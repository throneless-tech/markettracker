        ...
        <Tabs position="relative" variant="unstyled" colorScheme="teal">
          ...
          <Box>
            <Tabs position="relative" variant="unstyled">
              <TabList bg={"gray.50"}>
                <Tab _selected={{ color: "#000", fontWeight: "700" }}>
                  Markets
                </Tab>
                <Tab _selected={{ color: "#000", fontWeight: "700" }}>
                  Market Reports
                ...
                <TabPanel>
                  ...
                  <Container marginTop={8} maxW={"5xl"}>
                    ...
                    <Text color={"gray.600"} marginTop={4} fontSize={"sm"}>
                      [ DEFINITIONS ABOUT MARKET SIZES: flagship, large, medium,
                      small, farm stand] flagship market- can support 5 prepared
                      food vendors large market- can support 3 prepared food /
                      etc. vendors Remember, a Jedi can feel the Force flowing
                      through him. You are a part of the Rebel Alliance and a
                      traitor! Take her away! I suggest you try it again, Luke.
